...
namespace rVex
{
	...
	namespace Base
	{
		...
		{
			this->belongedInstruction = static_cast<rVex::Base::Instruction*>(instruction);
		}
		...
		Syllable::fillTypeII(VexParser::SyllableArguments& arguments) // O(1)
		{
			...
			{
				this->setLayoutType(rVex::Base::Syllable::LayoutType::ISTYPE);
				this->setShortImmediateValue(static_cast<unsigned short> (origin2.value));
			} else
			{
				this->setLayoutType(rVex::Base::Syllable::LayoutType::RTYPE);
		...
		Syllable::fillTypeIV(VexParser::SyllableArguments& arguments) // O(1)
		{
			...
			this->setLayoutType(rVex::Base::Syllable::LayoutType::RTYPE_BS);
		...
		Syllable::fillTypeVIII(VexParser::SyllableArguments& arguments) // O(1)
		{
			...
			this->setLayoutType(rVex::Base::Syllable::LayoutType::BRANCH);
		...
		Syllable::fillTypeX(VexParser::SyllableArguments& arguments) // O(1)
		{
			...
			this->setLayoutType(rVex::Base::Syllable::LayoutType::MEMTYPE);
