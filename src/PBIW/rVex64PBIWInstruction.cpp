...
namespace PBIW
{
  ...
  void
  rVex64PBIWInstruction::setSyllableReferences(const std::list<GenericAssembly::Interfaces::IOperation*>& list)
  {
  ...
  rVex64PBIWInstruction::getSyllableReferences() const
  {
  ...
  void
  rVex64PBIWInstruction::setBranchSlot(const Operand& operand, Operand& field)
  {
  ...
  void
  rVex64PBIWInstruction::setOpBRFslot(IOperand& operand)
  {
  ...
  void
  rVex64PBIWInstruction::setOpBRslot(IOperand& operand)
  {
    Operand& operandReference=dynamic_cast<Operand&> (operand);
