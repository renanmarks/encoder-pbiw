...
${OBJECTDIR}/rVexSyllable.o: rVexSyllable.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/rVexSyllable.o rVexSyllable.cpp

${OBJECTDIR}/rVexInstruction.o: rVexInstruction.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/rVexInstruction.o rVexInstruction.cpp
...
${TESTDIR}/Teste.o: Teste.cpp 
	${MKDIR} -p ${TESTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I. -I. -MMD -MP -MF $@.d -o ${TESTDIR}/Teste.o Teste.cpp
...
${OBJECTDIR}/grammar/grammar_nomain.o: ${OBJECTDIR}/grammar/grammar.o grammar/grammar.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/grammar/grammar_nomain.o grammar/grammar.c;\
	else  \
...
${OBJECTDIR}/grammar/lex_nomain.o: ${OBJECTDIR}/grammar/lex.o grammar/lex.c 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.c) -g -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/grammar/lex_nomain.o grammar/lex.c;\
	else  \
...
${OBJECTDIR}/rVexSyllable_nomain.o: ${OBJECTDIR}/rVexSyllable.o rVexSyllable.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/rVexSyllable_nomain.o rVexSyllable.cpp;\
	else  \
...
${OBJECTDIR}/rVexInstruction_nomain.o: ${OBJECTDIR}/rVexInstruction.o rVexInstruction.cpp 
	...
	then  \
	    ${RM} $@.d;\
	    $(COMPILE.cc) -g -Dmain=__nomain -MMD -MP -MF $@.d -o ${OBJECTDIR}/rVexInstruction_nomain.o rVexInstruction.cpp;\
	else  \
